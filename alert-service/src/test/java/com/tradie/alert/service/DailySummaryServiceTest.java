...
class DailySummaryServiceTest {
    ...
    void getDailySummary_noTrades_returnsZeros() {
        ...
        assertEquals(0, BigDecimal.ZERO.compareTo(data.totalPnl()));
    ...
    void getDailySummary_withWinsAndLosses_computesCorrectly() {
        ...
        assertEquals(600.0, data.totalPnl().doubleValue(), 0.01);
        assertEquals(500.0, data.bestTrade().doubleValue(), 0.01);
        assertEquals(-200.0, data.worstTrade().doubleValue(), 0.01);
    ...
    void getDailySummary_breakEvenTrade_countedInTotalTrades() {
        ...
        assertEquals(1, data.losses());
        assertEquals(100.0, data.totalPnl().doubleValue(), 0.01);
    }
