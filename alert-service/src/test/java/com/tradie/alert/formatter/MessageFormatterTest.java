...
class MessageFormatterTest {
    ...
    void formatDailySummary_positivePnl_showsPlusSign() {
        DailySummaryData data = new DailySummaryData(BigDecimal.valueOf(1250.0), 5, 4, 1, 80.0, BigDecimal.valueOf(500.0), BigDecimal.valueOf(-250.0), 2);
    ...
    void formatDailySummary_negativePnl_showsMinusSign() {
        DailySummaryData data = new DailySummaryData(BigDecimal.valueOf(-300.0), 3, 1, 2, 33.3, BigDecimal.valueOf(200.0), BigDecimal.valueOf(-500.0), 0);
        String result = formatter.formatDailySummary(data);
    ...
    void formatDailySummary_allLossDay_bestTradeShowsMinusNotPlus() {
        ...
        DailySummaryData data = new DailySummaryData(BigDecimal.valueOf(-550.0), 2, 0, 2, 0.0, BigDecimal.valueOf(-50.0), BigDecimal.valueOf(-500.0), 0);
        String result = formatter.formatDailySummary(data);
    ...
    void formatDailySummary_decimalFormattingUsesDotsRegardlessOfLocale() {
        ...
        try {
            ...
            DailySummaryData data = new DailySummaryData(BigDecimal.valueOf(1250.50), 5, 4, 1, 80.0, BigDecimal.valueOf(500.25), BigDecimal.valueOf(-250.75), 2);
            String result = formatter.formatDailySummary(data);
